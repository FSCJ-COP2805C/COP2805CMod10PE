...
public class HappyBirthdayApp implements BirthdayGreeter, Dispatcher<BirthdayCard>  {
    ...
    public static void main(String[] args) {
        ...
        // debugging code to check our environment
        ...
        UserDB.createDB();
        ArrayList<User> userList = UserDB.readUserDB();
        ...
        // DS 4/9/23 this block is disabled since the UserDB class is managing our data
/*
...
*/
        ...
        // disable the following, the UserDB class is managing our user data now
/*
